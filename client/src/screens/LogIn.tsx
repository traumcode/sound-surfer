...
function LogIn() {
    ...
    return (
        <div className="w-full bg-soundsurfer-background h-full bg-gradient-to-tl py-16 px-4">
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    <p
                        ...
                        className="text-2xl leading-6 text-gray-800"
                    >
                        Login to your account
                    </p>
                    <p className="text-sm mt-4 leading-none text-gray-500">
                        Dont have account?{' '}
                        <span
                            tabIndex={0}
                            role="link"
